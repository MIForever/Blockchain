...
## Task
Creating mini blockchain project that has nodes and inside of them blocks.

## Description
It is a simple project that has similar behaviours as real blockchain. You can perform actions like adding blocks or nodes or syncronise them on it.

## Installation
There is nothing to install. Simply download it and go on using it.

## Usage
You write a command make and it creates target called "my_blockchain". You run it and give it appropriate commands
